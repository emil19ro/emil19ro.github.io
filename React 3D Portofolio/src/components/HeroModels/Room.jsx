...
export function Room(props) {
  ...
  const myPhotoTexture = useTexture("/images/me.jpg");
  React.useEffect(() => {
    setModelLoaded(); // ✅ modelul este marcat ca încărcat
  }, [setModelLoaded]);
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh position={[0.3, 3.7, -2.96]} scale={[5, 3, 1]}>
        <planeGeometry args={[1.1, 1.25]} />
        <meshBasicMaterial map={myPhotoTexture} toneMapped={false} />
      </mesh>
      <mesh
        ref={screensRef}
